...
var _default = _backbone.default.View.extend({
  tagName: "li",
  template: _underscore.default.template((0, _jquery.default)('#trace-template').html()),
  events: {
...
exports.default = _default;
},{"backbone":"../node_modules/backbone/backbone.js","underscore":"../node_modules/underscore/modules/index-all.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"views/App.coffee":[function(require,module,exports) {
"use strict";
...
App = _backbone.default.View.extend({
  el: (0, _jquery.default)("#root"),
  statsTemplate: _underscore.default.template((0, _jquery.default)('#stats-template').html()),
  events: {
  ...
  initialize: function initialize() {
    ...
    this.main = (0, _jquery.default)('#main');
  ...
  clearCompleted: function clearCompleted() {
    _underscore.default.invoke(_UserList.default.done(), 'destroy');
...
exports.default = _default;
},{"backbone":"../node_modules/backbone/backbone.js","../collections/UserList.coffee":"collections/UserList.coffee","./User.coffee":"views/User.coffee","underscore":"../node_modules/underscore/modules/index-all.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"index.js":[function(require,module,exports) {
"use strict";
